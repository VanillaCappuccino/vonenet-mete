...
function runAllPerturbations(){
   ...
   for i in "${arr[@]}";
      do
          python imagenet-p-eval.py -m resnet18 -p "$i" --ngpu 1 --num_workers 16 --rn18_checkpoint checkpoints//epoch_60.pth.tar --data_dir /home/mete/repos/robustness/ImageNet-P/datasets/Tiny-ImageNet-P
          #-cp sthsth
      done
